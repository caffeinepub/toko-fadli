...
import type { Cart as _Cart, ExternalBlob as _ExternalBlob, Product as _Product, StoreSettings as _StoreSettings, Tier as _Tier, Time as _Time, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addOrUpdateProduct(arg0: bigint | null, arg1: string, arg2: string | null, arg3: string, arg4: bigint, arg5: bigint, arg6: Array<Tier>, arg7: ExternalBlob | null): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addOrUpdateProduct(to_candid_opt_n8(this._uploadFile, this._downloadFile, arg0), arg1, to_candid_opt_n9(this._uploadFile, this._downloadFile, arg2), arg3, arg4, arg5, arg6, await to_candid_opt_n10(this._uploadFile, this._downloadFile, arg7));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async checkout(arg0: string, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllSalesReports(): Promise<Array<Transaction>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllSalesReports();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCurrentCart(): Promise<Cart | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getCurrentCart();
    ...
    async getStoreSettings(): Promise<StoreSettings> {
        if (this.processError) {
            try {
                ...
                return from_candid_StoreSettings_n19(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async updateStoreSettings(arg0: string, arg1: string | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateStoreSettings(arg0, to_candid_opt_n9(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_StoreSettings_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _StoreSettings): StoreSettings {
...
function from_candid_opt_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Cart]): Cart | null {
    return value.length === 0 ? null : value[0];
}
...
function from_candid_record_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        receiptFooter: record_opt_to_undefined(from_candid_opt_n15(_uploadFile, _downloadFile, value.receiptFooter)),
...
async function from_candid_vec_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Product>): Promise<Array<Product>> {
